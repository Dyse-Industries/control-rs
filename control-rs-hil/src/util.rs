...
/// up to a safety margin below the current stack pointer.
///
/// # Safety
...
pub unsafe fn paint_stack() {
    ...
    // Safety margin to prevent overwriting active stack frames of the runner
    let margin = 1024;
...
pub unsafe fn scan_stack() -> u32 {
    ...
    let start_ptr = stack_start_ptr as *const u32;
    ...
    (stack_start_ptr - lowest_address) as u32
}
