...
impl<X: DenseStorage<f32>, Y: DenseStorageMut<f32>> Axpy<f32, X, Y> for AccelerateBlas {
    #[inline(always)]
...
impl<X: DenseStorage<f64>, Y: DenseStorageMut<f64>> Axpy<f64, X, Y> for AccelerateBlas {
    #[inline(always)]
...
impl<X: DenseStorage<f32>, Y: DenseStorage<f32>> Dotu<f32, X, Y> for AccelerateBlas {
    #[inline(always)]
    fn dotu(x: &X, y: &Y) -> f32 {
        #[cfg(all(target_vendor = "apple", feature = "accelerate"))]
        {
...
impl<X: DenseStorage<f64>, Y: DenseStorage<f64>> Dotu<f64, X, Y> for AccelerateBlas {
    #[inline(always)]
    fn dotu(x: &X, y: &Y) -> f64 {
        #[cfg(all(target_vendor = "apple", feature = "accelerate"))]
        {
...
> Gemm<f32, A, B, C> for AccelerateBlas {
    ...
    fn gemm(
        ...
        #[cfg(all(target_vendor = "apple", feature = "accelerate"))]
        {
            ...
            // If all are row-major or all are col-major
