...
use control_rs::matrix::{LuDecomposition, Matrix};
use control_rs_numerical_model_examples::{
    ABS_F64, SOLVE_RESIDUAL_TAU, print_matrix, solve_residual_ratio,
};
...
fn main() {
    ...
    // Column-major: encodes the same 2×2 matrices as NumPy [[1,2],[3,4]] and [[5,6],[7,8]].
    let m1 =
