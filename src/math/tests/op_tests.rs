...
mod add {
    ...
    fn f32_add() {
        ...
        assert_eq!(
            f32::MAX.try_add(&f32::MAX),
            Err(ArithmeticError::Overflow)
        );
        assert_eq!(
            f32::MIN.try_add(&f32::MIN),
            Err(ArithmeticError::Overflow)
        );
    }
}
...
mod sub {
    ...
    fn f32_sub() {
        ...
        assert_eq!(
            f32::MIN.try_sub(&f32::MAX),
            Err(ArithmeticError::Overflow)
        );
        assert_eq!(
            f32::MAX.try_sub(&f32::MIN),
            Err(ArithmeticError::Overflow)
        );
    }
}
