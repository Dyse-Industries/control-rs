...
mod level2 {
    ...
    fn test_gemv_f32() {
        ...
        // y[0] = 1*1 + 2*1 = 3
        // y[1] = 3*1 + 4*1 = 7
        Blasf32::gemv(1.0, &a, &x, 0.0, &mut y, 2, 2);
    ...
    fn test_gemv_f64() {
        ...
        let x = [1.0, 1.0];
        let mut y = [0.0, 0.0];
        Blasf64::gemv(1.0, &a, &x, 0.0, &mut y, 2, 2);
        assert_almost_eq!(y[0], 3.0);
        assert_almost_eq!(y[1], 7.0);
    }
...
mod level3 {
    ...
    fn test_gemm_f32() {
        ...
        let mut c = [0.0; 4];
        // C = 1.0 * A * I + 0.0 * C = A
        Blasf32::gemm(1.0, &a, &b, 0.0, &mut c, 2, 2, 2);
    ...
    fn test_gemm_f64() {
        ...
        let b = [1.0, 0.0, 0.0, 1.0]; // 2x2 identity
        let mut c = [0.0; 4];
        Blasf64::gemm(1.0, &a, &b, 0.0, &mut c, 2, 2, 2);
        assert_almost_eq!(c[0], 1.0);
        assert_almost_eq!(c[1], 2.0);
        assert_almost_eq!(c[2], 3.0);
        assert_almost_eq!(c[3], 4.0);
