...
|                                        | `cargo ci`          | `run --package control-rs-ci --bin ci --`                                | Runs the continuous integration pipeline locally.                      |
...
|                                        | `cargo teensy`      | `run --package control-rs-tui -- --serial --port /dev/ttyACM0`           | TUI → ETS (Teensy 4.0).                                                 |
